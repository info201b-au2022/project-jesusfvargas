...
data_2018 <- read.csv('Documents/info201/project-jesusfvargas/data/Report_Card_Graduation_2018-19.csv')
View(data_2018)

data_2019 <- read.csv('Documents/info201/project-jesusfvargas/data/Report_Card_Graduation_2019-20.csv')
View(data_2019)

data_2020 <- read.csv('Documents/info201/project-jesusfvargas/data/Report_Card_Graduation_2020-21.csv')
View(data_2020)
